...
const Hero = () => {
  return <section className="relative min-h-[85vh] flex items-center justify-center hero-gradient overflow-hidden">
      {/* Subtle grid pattern */}
      ...
      <div className="container relative z-10 px-6 pt-28 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-up-delay-2">Design, build and optimize your end to end go-to-market engine, from demand generation to revenue, powered by data, analytics and automation.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up-delay-3">
            ...
            <a href="#services" className="inline-flex items-center justify-center px-8 py-4 border border-border text-foreground font-medium rounded-lg hover:bg-secondary transition-colors">Explore Capabilities</a>
          </div>
